...
import Meniu.GameCompletedOverlay;
import Meniu.GameOverOverlay;
import Meniu.LevelCompletedOverlay;
import Meniu.PauseOverlay;
...
public class Playing extends State implements Statemethods {
	...
	private BufferedImage backgroundImg, bigForest, smallCloud, shipImgs[];
	...
	public Playing(Game game) throws Exception {
		super(game);
		initClasses();

		backgroundImg = LoadSave.GetSpriteAtlas(LoadSave.PLAYING_BG_IMG);
		bigForest = LoadSave.GetSpriteAtlas(LoadSave.BIG_FOREST);
	...
	private void drawClouds(Graphics g) {
		for (int i = 0; i < 4; i++)
			g.drawImage(bigForest, i * BIG_FOREST_WIDTH - (int) (xLvlOffset * 0.3), (int) (204 * Game.SCALE), BIG_FOREST_WIDTH, BIG_FOREST_HEIGHT, null);
