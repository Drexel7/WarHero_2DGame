...
public class Constants {
	...
	public static class EnemyConstants {
		...
		public static final int SOLDIER_DRAWOFFSET_X = (int) (27 * Game.SCALE);
		public static final int SOLDIER_DRAWOFFSET_Y = (int) (9 * Game.SCALE);
	...
	public static class Environment {
		public static final int BIG_FOREST_WIDTH_DEFAULT = 448;
		public static final int BIG_FOREST_HEIGHT_DEFAULT = 101;
		public static final int SMALL_CLOUD_WIDTH_DEFAULT = 74;
		public static final int SMALL_CLOUD_HEIGHT_DEFAULT = 24;

		public static final int BIG_FOREST_WIDTH = (int) (BIG_FOREST_WIDTH_DEFAULT * Game.SCALE);
		public static final int BIG_FOREST_HEIGHT = (int) (BIG_FOREST_HEIGHT_DEFAULT * Game.SCALE);
